...
const post3 = () => {
    ...
    <> 
        ...
        <p className={styles.text}>A máme hotovo, po cvíli by jste měli vidět logo ChromeOS Flex a dále uvítací obrazovku! Nyní již můžete nainstalovat ChromeOS Flex, pomocí stisknutí tlačítka <a>Install ChromeOS Flex</a> v pravém dolním rohu. Systém bude nainstalován na disk.img který jsme vytvořili před chvílí.</p>
